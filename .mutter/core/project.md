...
- **Cursor:** `mutter-cursor/rules/mutter.mdc` (plugin) or `.cursor/rules/mutter.mdc` in a consumer repo (minimal) points here. The **mutter** git repository does not track `.cursor/`; see `docs/mutter-cursor-ide-routing.md`.
